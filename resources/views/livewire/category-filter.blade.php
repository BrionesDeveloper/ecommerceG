        ...
        <aside>
            ...
            <ul class="divide-y divide-gray-200">
                @foreach ($category->subcategories as $subcategory)
                    <li class="py-2 text-sm">
                        <a class="cursor-pointer hover:text-fuchsia-500 capitalize {{ $subcategoria == $subcategory->slug ? 'text-fuchsia-500 font-semibold' : '' }}"
            ...
            <ul class="divide-y divide-gray-200">
                @foreach ($category->brands as $brand)
                    <li class="py-2 text-sm">
                        <a class="cursor-pointer hover:text-fuchsia-500 capitalize {{ $marca == $brand->name ? 'text-fuchsia-500 font-semibold' : ''}}"
            ...
            <x-jet-button class="mt-4 bg-pink-700" wire:click="limpiar">
                Eliminar filtros
            </x-jet-button>
        </aside>
                        ...
                        <li class="bg-white rounded-lg shadow">
                            <article>
                                ...
                                <div class="py-4 px-6">
                                        ...
                                        <p class="font-bold text-trueGray-700">MXM$ {{$product->price}}</p>
                                </div>
                            </article>
                        </li>
