<div>
    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <x-button-enlace class="ml-auto bg-yellow-500" href="{{route('admin.products.create')}}">
                Agregar producto
            </x-button-enlace>
        </div>
    </x-slot>
    ...
    <div class="container py-12">
        ...
        <x-table-responsive>
            ...
            @if ($products->count())
                ...
                <table class="min-w-full divide-y divide-fuchsia-700">
                    ...
                    <tbody class="bg-white divide-y divide-fuchsia-700">
