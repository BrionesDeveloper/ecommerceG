<header class="bg-pink-600 sticky top-0" style="z-index: 900 " x-data="dropdown()">
    ...
    <nav id="navigation-menu" 
        ...
        <div class="container h-full hidden md:block">
            <div
                ...
                <ul class="bg-pink-300">
                    @foreach ($categories as $category)
                        <li class="navigation-link text-fuchsia-700 hover:bg-yellow-200 hover:text-yellow-500">
                            ...
                            <div class="navigation-submenu bg-pink-100 absolute w-3/4 h-full top-0 right-0 hidden">
                ...
                <div class="col-span-3 bg-pink-100">
        ...
        <div class="bg-white h-full overflow-y-auto">
            ...
            <ul>
                @foreach ($categories as $category)
                    <li class="text-trueGray-500 hover:bg-fuchsia-700 hover:text-white">
                        <a href="{{route('categories.show', $category)}}" class="py-2 px-4 text-sm flex items-center">
